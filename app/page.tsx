...
export default function PasswordGeneratorPage() {
  ...
  const generatePassword = () => {
    ...
    // First, ensure at least one character from each selected pool
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-background">
      <Card className="w-full max-w-[520px] bg-card border-border shadow-lg">
        <CardHeader className="space-y-2">
          <CardTitle className="text-xl font-bold text-foreground">Generate Secure Password</CardTitle>
